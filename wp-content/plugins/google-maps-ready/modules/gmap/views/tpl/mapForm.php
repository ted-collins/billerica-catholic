<?php echo htmlGmp::formStart('editMapForm', array('attrs'=> 'id="gmpEditMapForm" class="gmpMapFormItm"')); ?>
	...
	<div class="gmpFormRowsCon">
		<h3><?php langGmp::_e('Markers Infowindows title style');?></h3>
		<div class="gmpFormRow">
			<div class="gmpFormElemCon">
			<?php
				echo htmlGmp::colorpicker('map_opts[infownd_title_color]', array(
					'attrs' => 'class="gmpHintElem"',
					'value' => '#A52A2A',
					'hint' => langGmp::_('Select color for maps title infowindow')));
			?>
			</div>
			<label for="" class="gmpFormLabel">
				<?php langGmp::_e('Title color')?>
			</label>
		</div>  
		<div class="gmpFormRow">
			<div class="gmpFormElemCon">
			<?php
				echo htmlGmp::text('map_opts[infownd_title_size]', array(
					'attrs' => 'class="gmpHintElem"  id="gmpNewMap_infownd_title_size"',
					'hint' => langGmp::_('InfoWindow Height'),
					'value' => '19'));
			?>
			</div>
			<label for="gmpNewMap_infownd_title_size" class="gmpFormLabel">
				<?php langGmp::_e('Title size, in px');?>
			</label>
		</div>
	</div>

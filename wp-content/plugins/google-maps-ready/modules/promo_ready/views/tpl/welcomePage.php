<style type="text/css">
	...
	#gmpWelcomePageNewFindUsForm label {
		line-height: 24px;
		margin-left: 20px;
		font-size: 14px;
		display: block;
...
jQuery(document).ready(function(){
	jQuery('#gmpWelcomePageNewFindUsForm input[type=radio][name=where_find_us]').change(function(){
	...
	/*jQuery('#gmpWelcomePageNewFindUsForm').submit(function(){
...
<div class="container">
	<form id="gmpWelcomePageNewFindUsForm" method="GET">
		<h1>

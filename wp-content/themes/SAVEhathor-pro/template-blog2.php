...
<div id="content" class="content_blog blog_style_b1" role="main">
			<div class="b2_pic_wrapper ">
					...
					<article class="post_format_standard odd">
                        ...
                        <div class="readmore"><a href="<?php the_permalink();?>" class="more-link2"><?php _e('Read more', 'hathor'); ?></a></div>
                    ...
                    <?php if(of_get_option('share_checkbox','hathor') == "1"){ ?>
                    <div class="share">
					<?php get_template_part('share_this');?></div><?php } ?>

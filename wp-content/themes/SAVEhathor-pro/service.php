...
<div class="midrow">
 ...
 <?php if ( of_get_option('block1_text') ) { ?>     
        ...
        <div class="link">
         <?php if ( of_get_option('block1_link') ) { ?><a <?php if(of_get_option('newtab_checkbox','hathor') == "1"){ ?> target="_blank" <?php } ?> href="<?php echo of_get_option('block1_link'); ?>" class="midbutton"><?php echo of_get_option('servicelink2'); ?></a><?php } ?></div>
        </div>
       ...
       <div class="midrow_blocks_wrap">
        ...
        <div class="link">
          <?php if ( of_get_option('block2_link') ) { ?><a <?php if(of_get_option('newtab_checkbox','hathor') == "1"){ ?> target="_blank" <?php } ?> href="<?php echo of_get_option('block2_link'); ?>" class="midbutton"><?php echo of_get_option('servicelink2'); ?></a><?php } ?></div>
        </div></div>
       ...
       <div class="midrow_blocks_wrap">
        ...
        <div class="link">
          <?php if ( of_get_option('block3_link') ) { ?><a <?php if(of_get_option('newtab_checkbox','hathor') == "1"){ ?> target="_blank" <?php } ?> href="<?php echo of_get_option('block3_link'); ?>" class="midbutton"><?php echo of_get_option('servicelink2'); ?></a><?php } ?></div>
        </div></div>
      ...
      <?php } ?>
        ...
        <div class="link">
          <?php if ( of_get_option('block4_link') ) { ?><a <?php if(of_get_option('newtab_checkbox','hathor') == "1"){ ?> target="_blank" <?php } ?> href="<?php echo of_get_option('block4_link'); ?>" class="midbutton"><?php echo of_get_option('servicelink2'); ?></a><?php } ?></div>
        </div></div>
